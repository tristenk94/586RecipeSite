...
var OktaAuthService = /** @class */ (function () {
    function OktaAuthService(router) {
        ...
        this.$isAuthenticated = new rxjs_1.Observable(function (observer) {
            _this.observer = observer;
            _this.isAuthenticated().then(function (val) {
                observer.next(val);
            });
        });
    }
    ...
    OktaAuthService.prototype.login = function (originalUrl) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        url = sessionStorage.getItem('okta-app-url');
